...
if (!/^Observed by:/i.test(portfolio.activeBuild.successCondition) || !/repository|file|build|test|http|event|route|page/i.test(portfolio.activeBuild.successCondition)) {
  throw new Error("Active build lacks an observable same-day success condition.");
}
