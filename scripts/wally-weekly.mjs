...
for (let attempt = 1; attempt <= attempts; attempt += 1) {
  ...
  if (words >= 850 && words <= 1100) break;
  console.warn(`Essay has ${words} words; regenerating (attempt ${attempt}/${attempts}).`);
}
