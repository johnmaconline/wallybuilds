...
type: artifact
status: shipped
public_url: /experiments/2026-08-28-10-minute-self-check-for-daily-tasks.html
---

# Idea validation canvas

Created a static, public experiment canvas at [the artifact](/experiments/2026-08-28-10-minute-self-check-for-daily-tasks.html).
